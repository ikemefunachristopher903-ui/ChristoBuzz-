...
import { checkPolicyAgreement } from "./policy.js"; // Policy agreement
...
window.signup = async function () {
  ...
  const policyAgreed = document.getElementById("policyCheckbox").checked;

  if (!policyAgreed) return alert("You must agree to the app policy to sign up.");
...
function showDemoContent() {
  ...
  // Show demo Reels
  loadReels(null, true); // null user = demo mode
  // Demo profile placeholder
